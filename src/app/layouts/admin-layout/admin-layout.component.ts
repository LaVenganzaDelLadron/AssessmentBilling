...
export class AdminLayoutComponent {
  ...
  sidebarItems: SidebarItem[] = [
    ...
    { label: 'School', route: '/admin/school', icon: 'M3 10 12 4l9 6v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V10Z' },
{ label: 'Programs', route: '/admin/classes', icon: 'M4 6h16M4 12h16M4 18h16' },
    ...
    { label: 'Year', route: '/admin/year', icon: 'M8 2v4m8-4v4M3 10h18M5 5h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z' }
  ];
