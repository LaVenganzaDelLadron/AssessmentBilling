...
@Component({
  selector: 'app-add-student-scholarship-modal',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './add-student-scholarship.modal.html'
})
export class AddStudentScholarshipModalComponent {
  ...
  form: CreateStudentScholarshipPayload = this.createEmptyForm();
  ...
  submit(): void {
    ...
    this.studentScholarshipsService.create({
      ...this.form,
      ...
      error: (error) => {
        this.isLoading = false;
        this.errorMessage = this.getErrorMessage(error) || 'Failed to assign scholarship';
      }
    });
  }
  ...
  private createEmptyForm(): CreateStudentScholarshipPayload {
    return {
      student_id: null,
      scholarship_id: null,
